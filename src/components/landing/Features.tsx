...
const defaultProps: FeaturesProps = {
  ...
  subtitle: "Our platform offers everything you need to grow your business and delight your customers.",
  features: [
    {
      title: "Lightning Fast",
      description: "Our platform is optimized for speed, ensuring your users have a seamless experience every time.",
      icon: DefaultIcons.speed
    },
    {
      title: "Scales With You",
      description: "Whether you have 10 or 10 million customers, our infrastructure grows with your business.",
      icon: DefaultIcons.scale
    },
    {
      title: "Bank-Grade Security",
      description: "Your data is protected with the latest security protocols and compliance standards.",
    ...
    {
      title: "Simple to Use",
      description: "Intuitive design means your team can get started without extensive training or onboarding.",
      icon: DefaultIcons.easy
    },
    {
      title: "24/7 Support",
...
export default function Features(props: FeaturesProps) {
  const { title, subtitle, features } = { ...defaultProps, ...props };
